...
public class OrgSalesorg{
	...
	public String getIselectsale() {
		return iselectsale;
	}

	public void setIselectsale(String iselectsale) {
		this.iselectsale = iselectsale;
	}
	...
	public String getPkSalesorg() {
		return pkSalesorg;
	}

	public void setPkSalesorg(String pkSalesorg) {
		this.pkSalesorg = pkSalesorg;
	}
	...
	public void initByCode(BaseDAO dao, String saleOrgId) throws DAOException {
		String getSql = "select A.PK_SALESORG,A.PK_VID from ORG_SALESORG A where A.DR = 0 and A.CODE = ?";
		SQLParameter parameter = new SQLParameter();
		parameter.addParam(saleOrgId);
		this.code = saleOrgId;
		this.dr = 0L;
		...
		if(!CollectionUtils.isEmpty(tempInfos)){
			...
			if(null != infoMap){
				this.pkSalesorg = (String) infoMap.get("pk_salesorg");
